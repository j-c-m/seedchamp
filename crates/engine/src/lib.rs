...
pub use library::{
    ...
    free_space_bytes, generate_peer_id_with_prefix, leech_cache_enabled, load_torrent_bytes,
    pkg_version_major, poll_watch_once, resolve_dl_path, resolve_ltep_client,
    resolve_peer_id_prefix, sanitize_path_component, serve_main, spawn_watcher,
    wanted_bytes_from_metainfo, AddOptions, AddReport, DlPathContext, Placement, WatchCallback,
    WatchHandle, WatchLoadEvent, DEFAULT_PEER_ID_PREFIX, PKG_VERSION,
};
